  ...
  template: `
    <div>
      <div class="hero-panel p-4 p-md-5 text-center mb-4">
        ...
        <h1 class="h3 fw-bold mt-3 mb-2">Find your next adventure</h1>
        <p class="text-muted mx-auto mb-4" style="max-width: 40rem;">
          Guided treks for every level of adventurer &mdash; from easy strolls to
          summit pushes. See where the community is headed right now, then create
          an account and book your next trail.
        </p>
        <div class="d-flex justify-content-center gap-2 flex-wrap">
          ...
          <template v-else>
            <router-link to="/register" class="btn btn-primary">
              <i class="bi bi-person-plus me-1"></i>Start exploring
            </router-link>
      ...
      <div v-if="loading" class="loading-box">
        ...
        Loading the live trail report&hellip;
      </div>
        ...
        <div class="row g-3">
          <div class="col-6 col-md-3">
            <div class="stat-card">
              ...
              <div class="stat-label">Treks on offer</div>
            </div>
          </div>
          <div class="col-6 col-md-3">
            <div class="stat-card">
          ...
          <div class="col-6 col-md-3">
            <div class="stat-card">
              ...
              <div class="stat-label">Trekkers on the trail</div>
            </div>
          </div>
        </div>

        <div v-if="stats.total_treks === 0" class="border rounded p-4 mt-4 text-center text-secondary">
          No treks on the trail just yet &mdash; new adventures are around the bend. Check back soon!
        </div>
            ...
            <div class="col-lg-5">
              <div class="border rounded p-4 h-100 d-flex flex-column">
                ...
                <ul class="list-unstyled small text-secondary d-flex flex-column gap-2 mb-4">
                  <li><i class="bi bi-check-circle-fill text-success me-2"></i>Discover open treks and filter by difficulty, duration and destination.</li>
                  <li><i class="bi bi-check-circle-fill text-success me-2"></i>Reserve your spot in seconds and follow your booking every step of the way.</li>
                  <li><i class="bi bi-check-circle-fill text-success me-2"></i>Get a reminder before departure and export your trekking history anytime.</li>
                </ul>
                <div class="mt-auto">
